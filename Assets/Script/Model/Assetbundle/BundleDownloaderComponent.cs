...
public class BundleDownloaderComponent : MonoBehaviour
{
    ...
    void LoadComplete() {
        ...
        ResourcesComponent res = go.AddComponent<ResourcesComponent>();
        //var obj = res.GetAsset("Cube.prefab", "prefab/Cube");
        //var obj = res.GetAsset("HotfixPanel", "prefab/HotfixPanel");
        //GameObject go=(GameObject)GameObject.Instantiate(obj);
        //go.transform.SetParent(canvas, false);
    ...
    public static string AssetBundleServerUrl = "http://192.168.0.144:8080/";// "http://193.112.44.199:8080/";
